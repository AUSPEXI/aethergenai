...
// High-signal informal terms/slang; keep conservative to avoid false positives
const TERMS = [
  'brother', 'bro ', ' bros', 'bro\b', 'mate', 'buddy', 'dude', 'matey',
  "y'all", "ya'll", "ain't", 'gonna', 'lol', 'haha', 'cheers', 'banter',
  // Overly whimsical metaphors we decided to avoid site-wide
  'Abra-cadabra', 'abracadabra', 'magic', 'magical', 'wizard', 'spell', 'spellbinding'
]
